...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'SaaS Multi-Niche API Documentation',
                'version' => '1.0.0',
                'description' => 'API RESTful pour système de réservation multi-niche (paragliding, surfing, etc.)',
            ],
        ...
        'securityDefinitions' => [
            'securitySchemes' => [
                ...
                */
                ...
                'organization' => [ // Header pour identifier l'organisation
                    'type' => 'apiKey',
